...
python3 automatisation/projets/organiser_par_date.py
...
# 3. Suivi météo (nécessite Internet + pip install -r requirements.txt)
python3 automatisation/projets/suivi_meteo.py
```
